...
# This copies the requirements.txt file from the local directory (on the host) into the Docker container.
COPY requirements.txt /app/requirements.txt

# This command would copy a second requirements file, in case you have heavier dependencies for production. It's commented out in this case.
# COPY requirements-heavy.txt /app/requirements-heavy.txt

# This installs the Python dependencies from the requirements.txt file.
RUN pip install --no-cache-dir -r requirements.txt

# This would install the Python dependencies from the requirements-heavy.txt file, if it was not commented out.
